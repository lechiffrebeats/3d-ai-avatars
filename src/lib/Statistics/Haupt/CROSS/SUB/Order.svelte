<script lang="ts">
  import { tests_order_stats } from "$lib/Statistics/Logic/HypothesisTests";
      ...
      },
      {
        ...
        encoding: {
          ...
          tooltip: [
            ...
            { field: "diff", title: "Differenz (AB−BA)", format: ".2f" },
            { field: "lo", title: "95%-KI unten", format: ".2f" },
            { field: "hi", title: "95%-KI oben", format: ".2f" },
            { field: "mean_AB", title: "Mittelwert AB", format: ".2f" },
            { field: "mean_BA", title: "Mittelwert BA", format: ".2f" },
